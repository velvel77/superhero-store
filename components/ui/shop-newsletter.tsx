...
export default function ShopNewsLetter() {
  return (
    <section className="diagonal-stripes flex justify-between border-b-2 border-ui-border bg-secondary-500 px-4 py-16">
      <div className="flex justify-between w-full max-w-260 mx-auto">
        <div className="flex items-center gap-2">
          <Zap className="text-basic-100 border border-ui-border p-2 size-10 rounded-sm" />
          <div>
        ...
        <form className="flex border-2 border-ui-border/80" action="">
          <input className="outline-0 p-2 text-sm text-basic-100 placeholder:text-basic-200" required type="email" placeholder="hero@email.com" />
          <button
