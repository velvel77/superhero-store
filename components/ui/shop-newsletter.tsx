...
export default function ShopNewsLetter() {
  return (
    <section className="diagonal-stripes flex justify-between border-b-2 border-white bg-secondary-500 px-4 py-16">
      <div className="flex justify-between w-full max-w-260 mx-auto">
        ...
        <form className="flex border-2 border-white/80" action="">
          ...
          <button
            className="p-2 flex items-center gap-2 hover:bg-white/90 bg-white text-secondary-500"
            type="submit"
          >
