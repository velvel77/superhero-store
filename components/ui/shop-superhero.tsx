...
import { Award, Heart, MinusIcon, PlusIcon, RotateCcw, Shield, Truck, Zap } from 'lucide-react';
...
export default function Superhero({ hero, relatedProducts }: Props) {
  ...
  const stats = [
    { label: 'Combat', value: combat, color: 'bg-secondary-500' },
    { label: 'Speed', value: speed, color: 'bg-primary-500' },
    { label: 'Strength', value: strength, color: 'bg-rarity-legendary' },
    { label: 'Intelligence', value: intelligence, color: 'bg-effect-light-blue' },
    { label: 'Energy', value: energy, color: 'bg-rarity-epic' },
    { label: 'Durability', value: durability, color: 'bg-rarity-uncommon' },
  ];
            ...
            <section className="flex-1">
              ...
              <div>
                ...
                <div className="flex py-4 gap-4">
                  ...
                  {/* Hire */}
                  <button type="button" className="bg-secondary-500 p-4 flex-2 border-2 border-basic-100 rounded-sm">
                    Hire
                  </button>
                  {/* Favorite */}
                  <button
          ...
          <section className="py-16">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {relatedProducts.map((product) => (
                <Link href={`/products/${product.id}`} className="relative block" key={product.id}>
