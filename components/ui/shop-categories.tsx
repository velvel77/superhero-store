...
export default function ShopCategories() {
  return (
    <section className="benday-dots bg-(--color-effect-blue) py-8">
      <div className=" mx-auto w-full max-w-260">
        <div className="text-white relative p-4 grid items-center">
          <div className="absolute mx-4 h-7 w-1 bg-(--color-effect-yellow)"></div>
          ...
          {categories.map((item) => (
            ...
            >
              ...
              <span className="absolute bottom-4 left-4">
                ...
                <div className="uppercase flex gap-2 items-center text-(--color-text-muted) text-[.6rem]">
