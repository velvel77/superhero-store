          ...
          <main className="flex my-4 gap-4">
            ...
            <div>
              <div className="relative">
                ...
                <span className="absolute top-2 left-2">Rarity</span>
                <span className="absolute top-2 right-2">Status</span>
                {/* Extra images */}
              </div>
            </div>
            ...
            <section className="max-w-120">
              <div>
                <span className="uppercase tracking-widest font-bold text-effect-red text-[.7rem]">Suits</span>
                <h2 className="text-shadow-md text-shadow-effect-red italic font-bold text-3xl">
                  SHADOW OPS TACTICAL SUIT
                </h2>
                <div className="py-4 mb-4 border-b border-basic-400/20">
                  <span className="text-effect-yellow text-2xl">$2450</span>{' '}
                  <span className="text-[.5rem]"> / unit</span>
                </div>
              </div>
              <div>
                ...
                <div className="flex py-4 gap-4">
                  ...
                  {/* Add to cart */}
                  <button className="bg-effect-red p-4 flex-2 border-2 border-base-white rounded-sm">
                    Add to cart
                  </button>
                  {/* Favorite */}
                  <button
