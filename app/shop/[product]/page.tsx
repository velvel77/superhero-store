				...
				<div className="flex flex-col">
					<main className="flex my-4 gap-4">
						...
						<section className="max-w-120">
							<div>
								<span className="uppercase tracking-widest font-bold text-secondary-500 text-[.7rem]">
									Suits
								</span>
								<h2 className="text-shadow-md text-shadow-secondary-500 italic font-bold text-3xl">
									SHADOW OPS TACTICAL SUIT
								</h2>
							...
							<div>
								<p className="text-[.7rem] mb-4 text-basic-400">
									Engineered with quantum-weave fiber and
									shock-absorbing plating. This suit adapts to
									the wearer's movements, redistributing
									kinetic energy across micro-channels for
								...
								<div className="flex py-4 gap-4">
									...
									<div className="flex flex-1 rounded-sm border-2 border-ui-border bg-overlay-dark-soft text-basic-400">
										{/* Decrease amount */}
										<button
										...
										>
											<MinusIcon className="self-center size-5 group-hover:text-white" />
										</button>
										{/* Amount */}
										...
										>
											<PlusIcon className="self-center size-5 group-hover:text-white" />
										</button>
									</div>
									{/* Add to cart */}
									<button className="bg-secondary-500 p-4 flex-2 border-2 border-ui-border rounded-sm">
										Add to cart
									</button>
									{/* Favorite */}
									<button
										onClick={() => setFavorite(!favorite)}
										className={`size-16 border-2 hover:border-secondary-500 bg-overlay-dark-soft ${favorite ? "border-secondary-500 text-secondary-500" : "border-ui-border text-basic-400"} rounded-sm group flex items-center justify-center`}
									>
										<Heart
